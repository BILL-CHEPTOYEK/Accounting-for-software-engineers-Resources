...
function UserFormModal({ show, onClose, onSubmit, user, branches }) {
  ...
  const [formData, setFormData] = useState({
    ...
    is_active: true,
    branch_id: '', // Associate user with a branch
  });
  ...
  // Use Bootstrap's modal-lg for a wider modal, preventing content overflow
  const modalClass = show ? 'modal fade show d-block' : 'modal fade';
  const modalDialogClass = show ? 'modal-dialog modal-dialog-centered modal-lg' : 'modal-dialog modal-dialog-centered'; // Added modal-lg
  ...
  return (
    <div className={modalClass} tabIndex="-1" role="dialog" style={modalStyle}>
      <div className={modalDialogClass} role="document"> {/* Applied modal-lg here */}
        <div className="modal-content">
          ...
          <form onSubmit={handleSubmit}>
            <div className="modal-body">
              <div className="row"> {/* Use row for better spacing on larger modals */}
              ...
              <div className="row">
                ...
                <div className="col-md-6 mb-3">
                  <label htmlFor="branch_id" className="form-label">Branch <span className="text-danger">*</span></label>
                  <select
              ...
              <div className="row">
                <div className="col-md-6 mb-3">
                  <label htmlFor="password" className="form-label">{isEditMode ? 'New Password (leave blank to keep current)' : 'Password'} <span className="text-danger">*</span></label>
                  <input
                    type="password"
