...
        { 
          ...
          as: 'lineItems',
          include: [{ model: ChartOfAccount, as: 'account' }] // NEW: Include associated account for each line item
        } 
      ],
...
    }
    ...
    // Validate account_id for each incoming line item
...
    let newInvoiceStatus;
    ...
    const revenueByAccount = invoice.lineItems.reduce((acc, item) => {
        // Ensure account_id is present and a valid amount
